    ...
    return render`
        ...
        <div class="page-layout">
            <div class="page-layout__container twelve-column-grid">
                <h1><glyph-headline light>Datenschutz</glyph-headline></h1>
                <simple-text><p>Wir freuen uns über Ihr Interesse an unserer Website und unserem Unternehmen.<br></p>
                    ...
                    Personenbezogene Daten sind Informationen zu Ihrer Identität. Hierunter fallen z.B. Angaben wie Name, Adresse, Telefonnummer, E-Mail-Adresse.<br>
                    </p>
                    <p>
                    ...
                    Soweit Sie uns personenbezogene Daten zur Verfügung stellen, verwenden wir diese nur zur Beantwortung Ihrer Anfragen und zur Abwicklung von Projekten, in Bezug auf Werbemaßnahmen Ihnen gegenüber, um Ihnen Zugang zu bestimmten Informationen oder Angeboten zu verschaffen oder Nutzung von Informations- und Kommunikationssystemen sowie im Rahmen gesetzlicher Vorgaben.<br>
                    Wir werden die von Ihnen online zur Verfügung gestellten personenbezogenen Daten nur für die Ihnen mitgeteilten Zwecke erheben, verarbeiten und nutzen. Ihre personenbezogenen Daten werden an Dritte nur weitergegeben oder sonst übermittelt, wenn dies zum Zwecke der Durchführung der hier genannten Tätigkeiten erforderlich ist, z.B. bei Einschaltung von Dienstleistern oder wenn Sie zuvor in die Weitergabe eingewilligt haben. Diese Dritten dürfen die Daten nicht zu anderen Zwecken verwenden.<br>
                    Selbstverständlich respektieren wir es, wenn Sie uns Ihre personenbezogenen Daten nicht zur Unterstützung unserer Kundenbeziehung (insbesondere für Direktmarketing oder zu Marktforschungszwecken) überlassen wollen.<br>
                    Wir geben persönliche Daten über Kunden oder Lieferanten nur bekannt, wenn wir hierzu gesetzlich verpflichtet sind, bzw. sofern wir durch eine gerichtliche Entscheidung dazu verpflichtet sind oder wenn die Weitergabe erforderlich ist, um unsere Allgemeinen Geschäftsbedingungen oder andere Vereinbarungen durchzusetzen oder zu schützen. Dies gilt entsprechend in Bezug auf die Speicherung der Daten.<br>
                    ...
                    Wenn Sie sich bei uns bewerben möchten, freuen wir uns darüber. Für den Zweck der Bewerbung stellen Sie uns die für eine Bewerbung üblichen personenbezogenen Daten zur Verfügung, gerne postalisch oder auch per E-Mail.<br>
                    Sie erklären sich dann mit der Verarbeitung und Übermittlung Ihrer Daten an uns ausschließlich für den Bewerbungsprozess einverstanden. Die von Ihnen übermittelten personenbezogenen Daten werden ausschließlich zum Zwecke der Bearbeitung Ihrer Bewerbung erhoben, verarbeitet und genutzt. Ihre Daten werden vertraulich behandelt. Ohne Ihre explizite Zustimmung findet eine Weitergabe an Dritte nicht statt.<br>
                    Sollten Sie Ihre Online-Bewerbung nicht aufrechterhalten wollen, können Sie diese schriftlich jederzeit zurückziehen.
                    Nach Beendigung des Bewerbungsverfahrens oder wenn Sie Ihre Bewerbung zurückziehen, werden Ihre im Rahmen der Bewerbung übermittelten Daten entsprechend den jeweils anwendbaren Vorschriften gelöscht.<br>
                    Wenn wir Ihnen aktuell kein passendes Stellenangebot offerieren können und wir es für möglich halten, dass Ihre Bewerbung zu einem späteren Zeitpunkt für uns oder auch eine unserer Gesellschaften interessant sein könnte, bieten wir Ihnen gerne an, Ihre Bewerbung auch noch weiter zu speichern.<br>
                    Hierfür werden wir Sie in einer gesonderten E-Mail oder postalisch um Ihr Einverständnis bitten.  Sie können dieser Speicherung jederzeit widersprechen, was die Folge hat, dass Ihre Daten umgehend und unwiderruflich gelöscht werden.<br>
                    </p>
                    <p>
                    ...
                    Sie können der Datenerhebung jederzeit mit Wirkung für die Zukunft widersprechen, indem Sie das Deaktivierungs-Add-on für Browser von Google Analytics unter <a href="http://tools.google.com/dlpage/gaoptout?hl=de">http://tools.google.com/dlpage/gaoptout?hl=de</a>  verwenden.<br><br>
                    ...
                    Wir weisen darauf hin, dass diese Website Google Analytics mit der Erweiterung „_anonymizeIp()“ verwendet. Dadurch werden IP-Adressen ausschließlich in anonymisierter Form gespeichert, ein direkter Personenbezug im Zusammenhang mit den gespeicherten Daten ist damit ausgeschlossen.<br>
                    </p>
                    <p>
                    <b>9.   Google Tag Manager</b><br><br>
                    Diese Webseite verwendet den Google Tag Manager. Durch diesen Dienst können Website-Tags über eine Oberfläche verwaltet werden. Der Google Tool Manager implementiert lediglich Tags. Das bedeutet: Es werden keine Cookies eingesetzt und es werden keine personenbezogenen Daten erfasst. Der Google Tool Manager löst andere Tags aus, die wiederum ggf. Daten erfassen. Jedoch greift der Google Tag Manager nicht auf diese Daten zu. Wurde auf Domain- oder Cookie-Ebene eine Deaktivierung vorgenommen, so bleibt sie für alle Tracking-Tags bestehen, insofern diese mit dem Google Tag Manager implementiert werden.<br><br>
                    <a href="javascript:gtmOptOut();alert('Sie haben sich erfolgreich von der Erfassung über den Google Tag Manager ausgeschlossen.');">Klicken Sie hier, um von der Erfassung über den Google Tag Manager ausgeschlossen zu werden.<br><br></a>
                    ...
                    Sofern Ihre Daten bei uns nicht richtig sein sollten, können Sie natürlich auch eine Berichtigung oder Vervollständigung Ihrer Daten verlangen.<br><br>
                    Auch können Sie eine Löschung Ihrer Daten verlangen, soweit nicht die Verarbeitung zur Ausübung des Rechts auf freie Meinungsäußerung und Information, zur Erfüllung einer rechtlichen Verpflichtung, aus Gründen des öffentlichen Interesses oder zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen erforderlich ist. Diesem Wunsch auf Löschung werden wir unverzüglich nachkommen, müssen dabei aber natürlich eventuell geltende gesetzliche Aufbewahrungsvorschriften beachten.<br><br>
                    ...
                    Wenn Sie eine Einwilligung zur Nutzung von Daten erteilt haben, können Sie diese jederzeit mit Wirkung für die Zukunft widerrufen.<br><br>
                    Sie haben auch ein Recht auf Datenübertragbarkeit. Wir werden Ihnen, bei einem entsprechenden Antrag von Ihrer Seite, Ihre Daten in einem maschinenlesbaren Format zur Verfügung stellen.<br><br>
                    Sofern Ihre personenbezogenen Daten auf Grundlage von berechtigten Interessen gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden, haben Sie das Recht, gemäß Art. 21 DSGVO Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten einzulegen, soweit dafür Gründe vorliegen, die sich aus Ihrer besonderen Situation ergeben oder sich der Widerspruch gegen Direktwerbung richtet. Im letzteren Fall haben Sie ein generelles Widerspruchsrecht, das ohne Angabe einer besonderen Situation von uns umgesetzt wird.<br><br>
                    Alle Informationswünsche, Auskunftsanfragen, Anträge auf Löschung, etc. oder Widersprüche zur Datenverarbeitung richten Sie bitte an die unten angegebenen Kontaktdaten unseres Datenschutzbeauftragten.<br><br>
                    Sie haben, falls Sie mit unserer Datenverarbeitung nicht einverstanden sein sollten, auch das Recht, sich bei der für uns zuständigen Aufsichtsbehörde für den Datenschutz zu beschweren.<br><br>
                    ...
                    Wir würden uns aber freuen, wenn Sie zuerst mit uns sprechen würden, damit wir mögliche Unklarheiten oder Unsicherheiten gemeinsam klären können.<br>
                    </p>
                    <p>
                    <b>11.  Datensicherheit</b><br><br>
                    Wir unterhalten aktuelle technische Maßnahmen zur Gewährleistung der Datensicherheit, insbesondere zum Schutz Ihrer personenbezogenen Daten vor Gefahren bei Datenübertragungen sowie vor Kenntniserlangung durch Dritte. Diese werden dem aktuellen Stand der Technik entsprechend jeweils angepasst.<br>
                    </p>
                    <p>
                    ...
                    Sollten Sie weitere Fragen zur Erhebung, Verarbeitung und Nutzung Ihrer personenbezogenen Daten haben, dann wenden Sie sich bitte an unseren Datenschutzbeauftragten<br><br>
                    Virtual Identity AG<br>
